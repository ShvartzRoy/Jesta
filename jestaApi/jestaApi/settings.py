"""
Django settings for jestaApi project.
...
EMAIL_HOST_PASSWORD = 'iuhq noak vddp ghxl'
DEFAULT_FROM_EMAIL = 'itsjesta@gmail.com'


# For development: Print email verification codes to the console
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
# DEFAULT_FROM_EMAIL = 'no-reply@jesta.local'